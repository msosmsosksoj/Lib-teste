...
function Library:CreateWindow(WindowInfo)
    ...
    -- HEADER (onde fica o título + seta)
    ...
    local function ToggleGroupbox()
        ...
        -- gira seta
        TweenService:Create(ArrowImage, TweenInfo.new(0.25), {
            Rotation = Groupbox.Minimized and 180 or 0
        }):Play()
        ...
        if Groupbox.Minimized then
            ...
            for _, Depbox in ipairs(Groupbox.DependencyBoxes) do
    ...
    ToggleButton.MouseButton1Click:Connect(ToggleGroupbox)
